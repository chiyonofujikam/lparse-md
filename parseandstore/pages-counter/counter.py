...
if __name__ == '__main__':
    # chunk()
    p0 = r"C:\Users\Consultant\OneDrive - IKOSCONSULTING\Bureau\lparse-md\downloads\chunck_7_rev"
    for path in os.listdir(p0):
        path = os.path.join(p0, path)

        pdf_pages = get_num_pages(path)
        TOTAL += pdf_pages

    print(f"Overall number of pages in {p0}: {TOTAL + 254} ")
